...
const TicTacToe = () =>{
    ...
    const won = (winner) => {
        setLock(true);
        if(winner === "X"){
            titleRef.current.innerHTML = "Congratulations Mr. X";
        }
        else{
            titleRef.current.innerHTML = "Congratulations Mr. O"
        }
    }
    const reset = () =>{
        setLock(false);
        data = ["","","","","","","","",""]
        titleRef.current.innerHTML = "TicTacToe Game<span>React</span>"
        box_arr.map( (item) => {
